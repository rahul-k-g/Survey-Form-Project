...
function PreviewQuestions() {
  ...
  async function fetchQuestions() {
    const resp = await fetch("https://surveyformprojectbackend.onrender.com/api/getqstns", {
      method: "GET",
      headers: {
  ...
  const handleQuestion = async (event) => {
    ...
    const resp = await fetch(
      "https://surveyformprojectbackend.onrender.com/api/updateqstns",
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
                      ...
                      {items.qstn1option == "Yes" && (
                        <div>
                          <input
                            ...
                            value="Yes"
                            checked
                            onClick={(e) => setQstn1option(e.target.value)}
                          />
                          <span className="radiotext">Yes</span> <br />
                          <input
                            type="radio"
                            name="qstn1option"
                            id="qstn1option2"
                          ...
                          <input
                            ...
                            onClick={(e) => setQstn1option(e.target.value)}
                          />
                          <span className="radiotext">Not sure</span>
                          <br />
                        </div>
                      )}
                      ...
                      {items.qstn2option == "Yes" && (
                        <div>
                          <input
                            ...
                            value="Yes"
                            checked
                            onClick={(e) => setQstn2option(e.target.value)}
                          />
                          <span className="radiotext">Yes</span> <br />
                          <input
                            type="radio"
                      ...
                      {items.qstn3option == "Yes" && (
                        <div>
                          <input
                            ...
                            value="Yes"
                            checked
                            onClick={(e) => setQstn3option(e.target.value)}
                          />
                          <span className="radiotext">Yes</span> <br />
                          <input
                            type="radio"
